...
class PipelineStructure:
    ...
    def model_selector(self, indexes):
        ...
        return (
            set(M) == set(self.M) and set(O) == set(self.O)
    ...
    def make_candidates(self):
        ...
        dist_dict = dict(zip(dist_keys, dist_candidates, strict=False))
...
class MultiPipelineStructure:
    ...
    def tune(
        ...
        for pipeline, n_iter in zip(self.pipelines, n_iters, strict=False):
