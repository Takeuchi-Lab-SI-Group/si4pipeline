...
def cook_si(a,b,z,X,A,O,Iv,lamda):
    ...
    # 切断区間の共通区間
    Iv = common_func.interval_disassembly(interval,Iv)
...
def dffits_si(a,b,z,X,A,O,Iv,lamda):
...
def soft_ipod_si(a,b,z,X,A,O,Iv,lamda):
